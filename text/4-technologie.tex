...
%%% ML: pridat logo projektu QGIS a QT?
...
je projektem \zkratka{OSGeo}\footnote{\url{http://www.osgeo.org/}}  a~je 
...
% MultiPolygon} a \texttt{GeometryCollection})
...
licencemi \zk{LGPL} verze 2.1, \zk{GPL} verze 3.0, ale existuje i~komerční 
...
%%% ML: prilis mnoho poznamek pod carou
