...
% prichyceni polygonu do jednoho bodu a problém opakujících se bodů
% nevalidni geometrie
% doplnit obrázky s ukázkami

\section{MatchingGeometry}
% určí vždy jen první pasující geometrii, ale to nemusí být ta nejvíce pasující
% tento problém především u linií, vhodnější RoadMatcher/LineMatcher
% teoreticky by šlo najít všechny pasující, ale jak určit kritérium, 
% která pasuje lépe?
% doplnit obrázky s ukázkami
