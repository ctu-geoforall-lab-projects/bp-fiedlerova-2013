...
\begin{picture}(250, 210)
  ...
  \put(  1,  80){\line(1, 0){10} {\textbf{ text}}}
  \put( 16,  70){\line(0, 1){8}}
  \put( 16,  70){\line(1, 0){10} {\textbf{ latex}}}
  \put(150,  70){ zdrojové soubory textu této práce}
  \put( 16,  60){\line(0, 1){10}}
  \put( 16,  60){\line(1, 0){10} { tereza-fiedlerova-bp-2013.xls}}
  \put(150,  60){ anotace práce}
  \put( 16,  50){\line(0, 1){10}}
  \put( 16,  50){\line(1, 0){10} { tereza-fiedlerova-bp-2013.pdf}}
  \put(150,  50){ tento text}
  \put( 16,  40){\line(0, 1){10}}
  \put( 16,  40){\line(1, 0){10} { zadani-oficialni.jpeg}}
  \put(150,  40){ naskenované oficiální zadání práce}
\end{picture}